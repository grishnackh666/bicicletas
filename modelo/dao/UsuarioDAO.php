...
class UsuarioDAO {
	 ...
	 public function autenticarUsuario($correo, $password){
        ...
        }//else{echo "el ususario ya esta registrado";}
    ...
    public function registrarUsuario(Usuario $usuario){
        ...
        //$c = mysql_num_rows(mysql_query("SELECT * FROM usuario WHERE correo='$usuario'"));
        //if($c == 1 ){ echo "el ususario ya esta registrado"; }
        //else{
        $stmt1 = "INSERT INTO usuario VALUES (NULL, :nroCedula, :nombres, :apellidos,:correo,:password, :direccion, :telefono, :imagen)";
    ...
    public function eliminarUsuario($id){
        ...
        $resultado = $data_source->ejecutarActualizacion($stmt1, array(':idUsuario' => $id));
    ...
    public function verUsuarioPorId($id){
        ...
        $data_table = $data_source->ejecutarConsulta("SELECT * FROM usuario WHERE id = :idUsuario", array(':idUsuario'=>$id));
    ...
    public function editarUsuario($usuario){
        ...
        $stmt1 = "UPDATE usuario SET nroCedula = :nroCedula, nombres = :nombres, apellidos = :apellidos, correo = :correo, password = :password, direccion = :direccion, telefono = :telefono, imagen = :imagen  WHERE id = :idUsuario";
